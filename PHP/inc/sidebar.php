                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="<?php echo BASE_URL;?>/pages/password.php">Forgot Password</a>
                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="pagesCollapseForm" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="<?php echo BASE_URL;?>/pages/form-vertical.php">Form Vertical</a>
                                            <a class="nav-link" href="<?php echo BASE_URL;?>/pages/form-horizontal.php">Form Horizontal</a>
                                        </nav>
                                    </div>
                                </nav>
                            </div>
